...
translate Chinese strings:
    ...
    new "可访问性菜单。用户使用和向下箭头进行导航，然后输入以激活按钮和条。"
    ...
    new "此菜单上的选项旨在提高可访问性。它们可能无法与所有游戏一起使用，并且一些选项的组合可能使游戏无法玩。这不是游戏或引擎的问题。为了在更改字体时获得最佳结果，请尝试使文本大小保持与最初相同的方式。"
    ...
    new "自定义Director.Audio_Channels添加更多频道。"
    ...
    new "此保存是在其他设备上创建的。恶意构造的保存文件可能会损害您的计算机。您是否相信这个保存的创建者和所有可以更改文件的人？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "您是否相信保存创建的设备？如果您是设备的唯一用户，则只能选择“是”。"
    ...
    new "该计划包含许多许可下的免费软件，包括麻省理工学院许可证和GNU较少的通用公共许可证。可以在此处找到{a=https://www.renpy.org/l/license}的完整软件列表，包括指向完整源代码的链接{a=https://www.renpy.org/l/license}。"
    ...
    new "启用剪贴板声音。按“ shift+c”禁用。"

    # renpy/common/00preferences.rpy:703
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自我声明会说\“ [renpy.display.tts.last] \”。按“ Alt+Shift+V”将其禁用。"
    ...
    new "这会将您的保存上传到{a=https://sync.renpy.org} ren'py Sync Server {/a}。\ ndo您要继续吗？"
    ...
    new "您可以使用此ID下载在另一个设备上下载保存。\ n THIS SYNC将在一个小时内到期。\ nren'py Sync由{a=https://www.renpy.org/sponsors.html} Ren'py的赞助商{/a}支持。"
    ...
    new "\ n {color=#fff}复制到剪贴板。{/color}"

    # renpy/common/00iap.rpy:231
    old "Contacting App Store\nPlease Wait..."
    new "联系App Store \ nplease等待..."
    ...
    new "将Trackback.txt文件复制到剪贴板作为BBCODE，例如https://lemmasoft.renai.us/。"
    ...
    new "将Trackback.txt文件复制到剪贴板作为Discord的标记。"
    ...
    new "从磁盘重新加载游戏，如果可能的话，可以节省和恢复游戏状态。"
